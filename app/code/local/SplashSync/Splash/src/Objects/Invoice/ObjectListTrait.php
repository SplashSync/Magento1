...
/**
 * Magento 1 Orders Invoices Objects Lists Access
 */
trait ObjectListTrait
{
    /**
     * Return List Of Order's Invoices with required filters
     *
     ...
     *
     * @param Mage_Sales_Model_Order_Invoice $listObject
     *
     * @return array
     */
    protected function objectListToArray(Mage_Sales_Model_Order_Invoice $listObject): array
    {
