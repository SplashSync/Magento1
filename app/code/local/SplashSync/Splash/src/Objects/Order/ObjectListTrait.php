...
/**
 * Magento 1 Orders Address Objects Lists Access
 */
trait ObjectListTrait
{
     ...
     *
     * @param Mage_Sales_Model_Order $listObject
     *
     * @return array
     */
    protected function objectListToArray(Mage_Sales_Model_Order $listObject): array
    {
        ...
        return array(
            ...
            "state" => $this->getStandardOrderState($listObject->getState()),
        );
    }
}
